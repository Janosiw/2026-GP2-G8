(function () {
  const QA = [
    {
      patterns: ["add patient", "new patient", "create patient", "patient"],
    ...
    {
      patterns: ["add case", "new case", "create case", "case"],
      answer: "To create a new case: open the patient's profile, then click <b>+ New Case</b>. Set the start date and upload the first MRI scan.",
      chips: ["How do I upload an MRI?", "How do I share a case?"]
    },
    {
      patterns: ["mri", "upload", "scan", "image", "file", "nifti", "zip"],
      answer: "To upload an MRI scan: after opening a case, you'll be taken to the analysis page. Click the upload area or drag and drop your file.<br>Supported formats: <b>PNG, JPG</b> (2D) · <b>NIfTI .nii/.nii.gz</b> (3D) · <b>ZIP</b> containing a NIfTI file.",
      chips: ["What is the difference between 2D and 3D?", "How do I generate a report?"]
    },
    {
      patterns: ["2d", "3d", "difference", "nifti", "volume"],
      answer: "<b>2D (image):</b> PNG or JPG — the tumor type is classified and 2D segmentation is applied.<br><b>3D (NIfTI/ZIP):</b> .nii or ZIP file — the full tumor volume is analyzed using nnUNet and volume is calculated in cm³.",
      chips: ["How do I upload an MRI?", "How do I view Tumor Progress?"]
    },
    {
      patterns: ["report", "generate report", "download report"],
      answer: "To generate a report: open the case, then click <b>Generate Report</b> at the top of the page. You can download it or view it later from the Reports section.",
      chips: ["How do I share a case?", "Where is the Dashboard?"]
    },
    {
      patterns: ["share", "invite", "colleague", "collaborate"],
      answer: "To share a case with a colleague: open the case, click <b>Share Case</b>, and enter your colleague's email. They will receive an invitation email to access the case.",
      chips: ["How do I generate a report?", "Where is the Dashboard?"]
    },
    {
      patterns: ["dashboard", "analytics", "statistics", "charts"],
      answer: "The Dashboard is in the sidebar. It shows patient statistics, recovery rates, tumor type breakdown, and monthly trends.",
      chips: ["How do I view Tumor Progress?", "How do I change my password?"]
    },
    {
      patterns: ["tumor progress", "progress", "baseline", "change", "growth"],
    ...
    {
      patterns: ["password", "profile", "account", "edit profile", "change password"],
      answer: "To edit your profile or change your password: go to <b>Profile</b> from the top menu. Click the ✏️ pencil icon to edit your info, or the 🔒 lock icon to change your password.",
      chips: ["Where is the Dashboard?", "How do I share a case?"]
    },
    {
      patterns: ["help", "problem", "error", "not working", "issue", "failed"],
      answer: "If you're experiencing a technical issue:<br>• Make sure the uploaded file format is supported<br>• Refresh the page and try again<br>• Contact the administrator if the problem persists.<br>I'm here to help with any questions! 😊",
